...
<body>
    ...
    <header class="bg-primary navbar navbar-expand-md navbar-dark bd-navbar">
        <nav class="container-xxl flex-wrap flex-md-nowrap my-1" aria-label="Main navigation">
            <a class="navbar-brand d-flex align-items-center p-0 me-2" href="/" aria-label="Bootstrap">
                ...
                <span class="px-3">Hotel Hebat</span>
            </a>
            ...
            <div class="collapse navbar-collapse d-flex justify-content-end" id="bdNavbar">
                <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
                    <li class="nav-item col-6 col-md-auto">
                        <a class="nav-link p-2 active" href="index.php">Home</a>
                    </li>
                    <li class="nav-item col-6 col-md-auto">
                        <a class="nav-link p-2" href="about.php">Tentang Kami</a>
                    </li>
                    <li class="nav-item col-6 col-md-auto">
                        <a class="nav-link p-2" href="kamar.php">Kamar</a>
                    </li>
                    <li class="nav-item col-6 col-md-auto">
                        <a class="nav-link p-2" href="fasilitas.php">Fasilitas</a>
                    </li>
                    <li class="nav-item col-6 col-md-auto">
                        <a class="nav-link p-2" href="pemesanan.php">Pemesanan</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div
                    style="background-image: url('images/1.jpg');  background-size: cover; background-position: center; width: 100vw; height: 80vh;">
                </div>
            ...
            <div class="carousel-item">
                <div
                    style="background-image: url('images/2.jpg');  background-size: cover; background-position: center; width: 100vw; height: 80vh;">
                </div>
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <div
                    style="background-image: url('images/3.jpg');  background-size: cover; background-position: center; width: 100vw; height: 80vh;">
                </div>
                <div class="carousel-caption d-none d-md-block">
        ...
        <div class="row border bg-primary shadow">
            <div class="d-flex m-5 justify-content-center align-items-center">
                <div style="width: 200px;" class="input-group mx-2">
                    <input type="date" class="form-control shadow" placeholder="Recipient's username"
                ...
                <div style="width: 200px;" class="input-group mx-2">
                    <input type="text" class="form-control shadow" placeholder="Jumlah Kamar"
                        aria-label="Recipient's username" aria-describedby="button-addon2">
                </div>
                <div style="width: 200px; border: 1px solid white;" class="btn text-white shadow">
                    Pesan
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form>
                        <div class="mb-3 d-flex align-items-center justify-content-between">
                            ...
                            <input style="width: 80%" type="text" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3 d-flex align-items-center justify-content-between">
                            <label for="exampleInputEmail1" class="form-label">Email</label>
                            <input style="width: 80%" type="email" class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="mb-3 d-flex align-items-center justify-content-between">
                        ...
                        <div class="mb-3 d-flex justify-content-end">
                            <button type="submit" style="width: 200px" class="btn btn-primary">Pesan</button>
                        </div>
                    </form>
                </div>
            </div>
